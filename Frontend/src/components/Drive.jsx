...
export default function Drive() {
    ...
    return (
        <div className="card">
            <h2> Cloud Drive</h2>
            <p className="small"> Upload files. Files are stored on server in <code>/upload</code>.</p>
            <input type="file"
                ...
                {files.map((f) => (
                    <div className="file-item" key={f._id || f.filename}>
                        ...
                        <div>
                            ...
                            <a href={formatUrl(f)} target="_blank" rel="noreferrer" style={{ color: "var(--primary)", fontWeight: 700 }}>
                                Open
                            </a>
                        </div>
                    </div>
